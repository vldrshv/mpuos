...
;* Date/Time created: Sun Sep 01 14:41:59 2019                                 *
;*******************************************************************************
...
$C$DW$CU	.dwtag  DW_TAG_compile_unit
	.dwattr $C$DW$CU, DW_AT_name("../FTEST.C")
...
;	C:\ti\ccsv5\tools\compiler\c5500_4.4.1\bin\acp55.exe -@C:\\Users\\user\\AppData\\Local\\Temp\\0305612 
	.sect	".text"
	.global	_ftest

$C$DW$3	.dwtag  DW_TAG_subprogram, DW_AT_name("ftest")
	.dwattr $C$DW$3, DW_AT_low_pc(_ftest)
	.dwattr $C$DW$3, DW_AT_high_pc(0x00)
	.dwattr $C$DW$3, DW_AT_TI_symbol_name("_ftest")
	.dwattr $C$DW$3, DW_AT_external
	.dwattr $C$DW$3, DW_AT_type(*$C$DW$T$8)
	.dwattr $C$DW$3, DW_AT_TI_begin_file("../FTEST.C")
	.dwattr $C$DW$3, DW_AT_TI_begin_line(0x03)
	.dwattr $C$DW$3, DW_AT_TI_begin_column(0x07)
	.dwattr $C$DW$3, DW_AT_TI_max_frame_size(0x0e)
	.dwpsn	file "../FTEST.C",line 5,column 1,is_stmt,address _ftest

	.dwfde $C$DW$CIE, _ftest
$C$DW$4	.dwtag  DW_TAG_formal_parameter, DW_AT_name("r")
	.dwattr $C$DW$4, DW_AT_TI_symbol_name("_r")
	.dwattr $C$DW$4, DW_AT_type(*$C$DW$T$20)
	.dwattr $C$DW$4, DW_AT_location[DW_OP_reg17]
$C$DW$5	.dwtag  DW_TAG_formal_parameter, DW_AT_name("rtest")
	.dwattr $C$DW$5, DW_AT_TI_symbol_name("_rtest")
	.dwattr $C$DW$5, DW_AT_type(*$C$DW$T$20)
	.dwattr $C$DW$5, DW_AT_location[DW_OP_reg19]
$C$DW$6	.dwtag  DW_TAG_formal_parameter, DW_AT_name("n")
	.dwattr $C$DW$6, DW_AT_TI_symbol_name("_n")
	.dwattr $C$DW$6, DW_AT_type(*$C$DW$T$8)
	.dwattr $C$DW$6, DW_AT_location[DW_OP_reg12]
$C$DW$7	.dwtag  DW_TAG_formal_parameter, DW_AT_name("maxerror")
	.dwattr $C$DW$7, DW_AT_TI_symbol_name("_maxerror")
...
$C$DW$12	.dwtag  DW_TAG_variable, DW_AT_name("i")
	...
	.dwattr $C$DW$12, DW_AT_location[DW_OP_bregx 0x24 8]
$C$DW$13	.dwtag  DW_TAG_variable, DW_AT_name("eflag")
	.dwattr $C$DW$13, DW_AT_TI_symbol_name("_eflag")
	.dwattr $C$DW$13, DW_AT_type(*$C$DW$T$8)
	.dwattr $C$DW$13, DW_AT_location[DW_OP_bregx 0x24 9]
$C$DW$14	.dwtag  DW_TAG_variable, DW_AT_name("elevel")
	.dwattr $C$DW$14, DW_AT_TI_symbol_name("_elevel")
	.dwattr $C$DW$14, DW_AT_type(*$C$DW$T$19)
	.dwattr $C$DW$14, DW_AT_location[DW_OP_bregx 0x24 10]
$C$DW$15	.dwtag  DW_TAG_variable, DW_AT_name("emax")
	.dwattr $C$DW$15, DW_AT_TI_symbol_name("_emax")
	.dwattr $C$DW$15, DW_AT_type(*$C$DW$T$19)
	.dwattr $C$DW$15, DW_AT_location[DW_OP_bregx 0x24 11]
        MOV AC0, dbl(*SP(#6)) ; |5| 
        MOV T0, *SP(#4) ; |5| 
        MOV XAR1, dbl(*SP(#2))
        MOV XAR0, dbl(*SP(#0))
	.dwpsn	file "../FTEST.C",line 7,column 7,is_stmt
        MOV #-1, *SP(#9) ; |7| 
	.dwpsn	file "../FTEST.C",line 8,column 6,is_stmt
        MOV #0, *SP(#10) ; |8| 
	.dwpsn	file "../FTEST.C",line 9,column 6,is_stmt
        MOV #0, *SP(#11) ; |9| 
	.dwpsn	file "../FTEST.C",line 11,column 6,is_stmt
        MOV #0, *SP(#8) ; |11| 
	.dwpsn	file "../FTEST.C",line 11,column 10,is_stmt
        MOV *SP(#8), AR2 ; |11| 
        MOV *SP(#4), AR1 ; |11| 
        CMP AR2 >= AR1, TC1 ; |11| 
        BCC $C$L4,TC1 ; |11| 
...
$C$L1:    
$C$DW$L$_ftest$2$B:
	.dwpsn	file "../FTEST.C",line 13,column 5,is_stmt
        MOV dbl(*SP(#2)), XAR3
        MOV AR2, T0
        SFTL T0, #1 ; |13| 
        MOV dbl(*AR3(T0)), AC0 ; |13| 
        MOV dbl(*SP(#0)), XAR3
        MOV AR2, T0
        SFTL T0, #1 ; |13| 
        MOV dbl(*AR3(T0)), AC1 ; |13| 
$C$DW$16	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$16, DW_AT_low_pc(0x00)
	.dwattr $C$DW$16, DW_AT_name("__subd")
	.dwattr $C$DW$16, DW_AT_TI_call
        CALL #__subd ; |13| 
                                        ; call occurs [#__subd] ; |13| 
...
$C$DW$18	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$18, DW_AT_name("__fltid")
...
$C$DW$19	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$19, DW_AT_name("__cmpd")
	.dwattr $C$DW$19, DW_AT_TI_call
        CALL #__cmpd ; |13| 
                                        ; call occurs [#__cmpd] ; |13| 
        BCC $C$L2,T0 <= #0 ; |13| 
                                        ; branchcc occurs ; |13| 
$C$DW$L$_ftest$2$E:
	.dwpsn	file "../FTEST.C",line 15,column 8,is_stmt
        MOV *SP(#8), AR1 ; |15| 
        MOV AR1, *SP(#9) ; |15| 
	.dwpsn	file "../FTEST.C",line 16,column 8,is_stmt
        MOV *SP(#10), AR1 ; |16| 
        MOV AR1, *SP(#11) ; |16| 
	.dwpsn	file "../FTEST.C",line 17,column 8,is_stmt
        B $C$L4   ; |17| 
                                        ; branch occurs ; |17| 
$C$L2:    
$C$DW$L$_ftest$5$B:
	.dwpsn	file "../FTEST.C",line 20,column 5,is_stmt
        MOV *SP(#11), AR1 ; |20| 
        MOV *SP(#10), AR2 ; |20| 
        CMP AR2 <= AR1, TC1 ; |20| 
        BCC $C$L3,TC1 ; |20| 
...
$C$DW$L$_ftest$5$E:
$C$DW$L$_ftest$6$B:
	.dwpsn	file "../FTEST.C",line 20,column 22,is_stmt
        MOV AR2, AR1
        MOV AR1, *SP(#11) ; |20| 
$C$DW$L$_ftest$6$E:
$C$L3:    
$C$DW$L$_ftest$7$B:
	.dwpsn	file "../FTEST.C",line 11,column 14,is_stmt
        ADD #1, *SP(#8) ; |11| 
	.dwpsn	file "../FTEST.C",line 11,column 10,is_stmt
        MOV *SP(#4), AR1 ; |11| 
        MOV *SP(#8), AR2 ; |11| 
...
$C$DW$L$_ftest$7$E:
$C$L4:    
	.dwpsn	file "../FTEST.C",line 23,column 1,is_stmt
        MOV *SP(#9), T0 ; |23| 
	.dwpsn	file "../FTEST.C",line 24,column 1,is_stmt
        AADD #13, SP
	.dwcfi	cfa_offset, 1
...
$C$DW$21	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$21, DW_AT_name("C:\ti\workspace\MPUOS_Lab2\Debug\FTEST.asm:$C$L1:1:1567338119")
	.dwattr $C$DW$21, DW_AT_TI_begin_file("../FTEST.C")
	.dwattr $C$DW$21, DW_AT_TI_begin_line(0x0b)
	.dwattr $C$DW$21, DW_AT_TI_end_line(0x15)
$C$DW$22	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$22, DW_AT_low_pc($C$DW$L$_ftest$2$B)
	.dwattr $C$DW$22, DW_AT_high_pc($C$DW$L$_ftest$2$E)
$C$DW$23	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$23, DW_AT_low_pc($C$DW$L$_ftest$5$B)
	.dwattr $C$DW$23, DW_AT_high_pc($C$DW$L$_ftest$5$E)
$C$DW$24	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$24, DW_AT_low_pc($C$DW$L$_ftest$6$B)
	.dwattr $C$DW$24, DW_AT_high_pc($C$DW$L$_ftest$6$E)
$C$DW$25	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$25, DW_AT_low_pc($C$DW$L$_ftest$7$B)
	.dwattr $C$DW$25, DW_AT_high_pc($C$DW$L$_ftest$7$E)
	.dwendtag $C$DW$21

	.dwattr $C$DW$3, DW_AT_TI_end_file("../FTEST.C")
