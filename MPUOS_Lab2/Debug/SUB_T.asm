...
;* Date/Time created: Sun Sep 01 14:26:19 2019                                 *
;*******************************************************************************
...
$C$DW$CU	.dwtag  DW_TAG_compile_unit
	.dwattr $C$DW$CU, DW_AT_name("../TMS320C55x-DSP Library-2013/EXAMPLES/sub/SUB_T.C")
...
;******************************************************************************
	...
	.field  	_x+0,24
	.field  	0,8
	.field	3276,16			; _x[0] @ 0
	.field	6553,16			; _x[1] @ 16
	.field	9830,16			; _x[2] @ 32
	.field	13107,16			; _x[3] @ 48
$C$IR_1:	.set	4
	...
	.field  	0,8
	.field	328,16			; _y[0] @ 0
	.field	655,16			; _y[1] @ 16
	.field	983,16			; _y[2] @ 32
	.field	1311,16			; _y[3] @ 48
$C$IR_2:	.set	4
	...
	.field  	_rtest+0,24
	.field  	0,8
	.field	1475,16			; _rtest[0] @ 0
	.field	2949,16			; _rtest[1] @ 16
	.field	4424,16			; _rtest[2] @ 32
	.field	5898,16			; _rtest[3] @ 48
$C$IR_3:	.set	4
...
$C$DW$3	.dwtag  DW_TAG_subprogram, DW_AT_name("sub")
	.dwattr $C$DW$3, DW_AT_TI_symbol_name("_sub")
...
$C$DW$17	.dwtag  DW_TAG_variable, DW_AT_name("r")
	...
	.global	_scale
	.bss	_scale,1,0,0
$C$DW$18	.dwtag  DW_TAG_variable, DW_AT_name("scale")
	.dwattr $C$DW$18, DW_AT_TI_symbol_name("_scale")
	.dwattr $C$DW$18, DW_AT_location[DW_OP_addr _scale]
	.dwattr $C$DW$18, DW_AT_type(*$C$DW$T$27)
	.dwattr $C$DW$18, DW_AT_external
	.global	_eflag
	.bss	_eflag,1,0,0
$C$DW$19	.dwtag  DW_TAG_variable, DW_AT_name("eflag")
	.dwattr $C$DW$19, DW_AT_TI_symbol_name("_eflag")
	.dwattr $C$DW$19, DW_AT_location[DW_OP_addr _eflag]
	.dwattr $C$DW$19, DW_AT_type(*$C$DW$T$8)
	.dwattr $C$DW$19, DW_AT_external
;	C:\ti\ccsv5\tools\compiler\c5500_4.4.1\bin\acp55.exe -@C:\\Users\\user\\AppData\\Local\\Temp\\0191612 
	.sect	".text"
	.global	_main
...
$C$DW$20	.dwtag  DW_TAG_subprogram, DW_AT_name("main")
	...
	.dwattr $C$DW$20, DW_AT_TI_begin_file("../TMS320C55x-DSP Library-2013/EXAMPLES/sub/SUB_T.C")
	...
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/sub/SUB_T.C",line 67,column 1,is_stmt,address _main
...
$C$DW$21	.dwtag  DW_TAG_variable, DW_AT_name("i")
	...
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/sub/SUB_T.C",line 71,column 10,is_stmt
        MOV #0, *SP(#0) ; |71| 
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/sub/SUB_T.C",line 71,column 17,is_stmt
...
$C$L1:    
$C$DW$L$_main$2$B:
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/sub/SUB_T.C",line 71,column 30,is_stmt
        MOV AR1, T0 ; |71| 
        AMOV #_r, XAR3 ; |71| 
        MOV #0, *AR3(T0) ; |71| 
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/sub/SUB_T.C",line 71,column 25,is_stmt
        ADD #1, *SP(#0) ; |71| 
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/sub/SUB_T.C",line 71,column 17,is_stmt
        MOV *SP(#0), AR1 ; |71| 
        CMP AR1 < AR2, TC1 ; |71| 
...
$C$DW$L$_main$2$E:
$C$L2:    
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/sub/SUB_T.C",line 73,column 5,is_stmt
        MOV #1, *(#_scale) ; |73| 
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/sub/SUB_T.C",line 76,column 5,is_stmt
        AMOV #_r, XAR2 ; |76| 
        AMOV #_y, XAR1 ; |76| 
        AMOV #_x, XAR0 ; |76| 
        MOV *(#_scale), T1 ; |76| 
$C$DW$22	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$22, DW_AT_name("_sub")
...
||      MOV #4, T0
                                        ...
                                        ; call occurs [#_sub] ; |76| 
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/sub/SUB_T.C",line 79,column 5,is_stmt
        MOV #2, T1
        AMOV #_rtest, XAR1 ; |79| 
        AMOV #_r, XAR0 ; |79| 
...
||      MOV #4, T0
        ...
        MOV T0, *(#_eflag) ; |79| 
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/sub/SUB_T.C",line 81,column 5,is_stmt
        CMP *(#_eflag) == #-1, TC1 ; |81| 
        BCC $C$L3,TC1 ; |81| 
                                        ; branchcc occurs ; |81| 
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/sub/SUB_T.C",line 83,column 9,is_stmt
        MOV #-1, T0
$C$DW$24	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/sub/SUB_T.C",line 86,column 5,is_stmt
$C$L3:    
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/sub/SUB_T.C",line 87,column 1,is_stmt
        AADD #1, SP
	.dwcfi	cfa_offset, 1
...
$C$DW$26	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$26, DW_AT_name("C:\ti\workspace\MPUOS_Lab2\Debug\SUB_T.asm:$C$L1:1:1567337179")
	.dwattr $C$DW$26, DW_AT_TI_begin_file("../TMS320C55x-DSP Library-2013/EXAMPLES/sub/SUB_T.C")
...
$C$DW$27	.dwtag  DW_TAG_TI_loop_range
	...
	.dwattr $C$DW$20, DW_AT_TI_end_file("../TMS320C55x-DSP Library-2013/EXAMPLES/sub/SUB_T.C")
