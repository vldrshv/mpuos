...
;* Date/Time created: Sun Sep 01 14:42:00 2019                                 *
;*******************************************************************************
...
$C$DW$CU	.dwtag  DW_TAG_compile_unit
	.dwattr $C$DW$CU, DW_AT_name("../TEST.C")
...
$C$DW$3	.dwtag  DW_TAG_subprogram, DW_AT_name("test")
	.dwattr $C$DW$3, DW_AT_low_pc(_test)
	.dwattr $C$DW$3, DW_AT_high_pc(0x00)
	.dwattr $C$DW$3, DW_AT_TI_symbol_name("_test")
	.dwattr $C$DW$3, DW_AT_external
	.dwattr $C$DW$3, DW_AT_type(*$C$DW$T$8)
	.dwattr $C$DW$3, DW_AT_TI_begin_file("../TEST.C")
	.dwattr $C$DW$3, DW_AT_TI_begin_line(0x03)
	.dwattr $C$DW$3, DW_AT_TI_begin_column(0x07)
	.dwattr $C$DW$3, DW_AT_TI_max_frame_size(0x0c)
	.dwpsn	file "../TEST.C",line 5,column 1,is_stmt,address _test
...
$C$DW$13	.dwtag  DW_TAG_variable, DW_AT_name("eflag")
	...
	.dwattr $C$DW$13, DW_AT_location[DW_OP_bregx 0x24 7]
...
$C$DW$15	.dwtag  DW_TAG_variable, DW_AT_name("emax")
	...
	.dwattr $C$DW$15, DW_AT_location[DW_OP_bregx 0x24 9]
        ...
        MOV XAR1, dbl(*SP(#2))
        MOV XAR0, dbl(*SP(#0))
	.dwpsn	file "../TEST.C",line 7,column 7,is_stmt
        MOV #-1, *SP(#7) ; |7| 
	.dwpsn	file "../TEST.C",line 8,column 6,is_stmt
        MOV #0, *SP(#8) ; |8| 
	.dwpsn	file "../TEST.C",line 9,column 6,is_stmt
        MOV #0, *SP(#9) ; |9| 
	.dwpsn	file "../TEST.C",line 11,column 6,is_stmt
        MOV #0, *SP(#6) ; |11| 
	.dwpsn	file "../TEST.C",line 11,column 10,is_stmt
        MOV *SP(#6), AR2 ; |11| 
        MOV *SP(#4), AR1 ; |11| 
        CMP AR2 >= AR1, TC1 ; |11| 
        BCC $C$L4,TC1 ; |11| 
...
$C$L1:    
$C$DW$L$_test$2$B:
	.dwpsn	file "../TEST.C",line 13,column 5,is_stmt
        MOV AR2, T0
        MOV dbl(*SP(#0)), XAR3
        MOV *AR3(T0), AR1 ; |13| 
        MOV dbl(*SP(#2)), XAR3
        SUB AR1, *AR3(T0), AR1 ; |13| 
        ABS AR1, AR1 ; |13| 
        MOV AR1, *SP(#8) ; |13| 
        MOV *SP(#5), AR2 ; |13| 
        CMP AR1 <= AR2, TC1 ; |13| 
        BCC $C$L2,TC1 ; |13| 
                                        ; branchcc occurs ; |13| 
$C$DW$L$_test$2$E:
	.dwpsn	file "../TEST.C",line 15,column 8,is_stmt
        MOV *SP(#6), AR1 ; |15| 
        MOV AR1, *SP(#7) ; |15| 
	.dwpsn	file "../TEST.C",line 16,column 8,is_stmt
        MOV *SP(#8), AR1 ; |16| 
        MOV AR1, *SP(#9) ; |16| 
	.dwpsn	file "../TEST.C",line 17,column 8,is_stmt
        B $C$L4   ; |17| 
                                        ; branch occurs ; |17| 
$C$L2:    
$C$DW$L$_test$5$B:
	.dwpsn	file "../TEST.C",line 20,column 5,is_stmt
        MOV *SP(#9), AR1 ; |20| 
        MOV *SP(#8), AR2 ; |20| 
        CMP AR2 <= AR1, TC1 ; |20| 
        BCC $C$L3,TC1 ; |20| 
...
$C$DW$L$_test$5$E:
$C$DW$L$_test$6$B:
	.dwpsn	file "../TEST.C",line 20,column 22,is_stmt
        MOV AR2, AR1
        MOV AR1, *SP(#9) ; |20| 
$C$DW$L$_test$6$E:
$C$L3:    
$C$DW$L$_test$7$B:
	.dwpsn	file "../TEST.C",line 11,column 14,is_stmt
        ADD #1, *SP(#6) ; |11| 
	.dwpsn	file "../TEST.C",line 11,column 10,is_stmt
        MOV *SP(#4), AR1 ; |11| 
        MOV *SP(#6), AR2 ; |11| 
...
$C$L4:    
	.dwpsn	file "../TEST.C",line 23,column 1,is_stmt
        MOV *SP(#7), T0 ; |23| 
	.dwpsn	file "../TEST.C",line 24,column 1,is_stmt
        AADD #11, SP
	.dwcfi	cfa_offset, 1
...
$C$DW$17	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$17, DW_AT_name("C:\ti\workspace\MPUOS_Lab2\Debug\TEST.asm:$C$L1:1:1567338120")
	.dwattr $C$DW$17, DW_AT_TI_begin_file("../TEST.C")
	.dwattr $C$DW$17, DW_AT_TI_begin_line(0x0b)
	.dwattr $C$DW$17, DW_AT_TI_end_line(0x15)
$C$DW$18	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$18, DW_AT_low_pc($C$DW$L$_test$2$B)
	.dwattr $C$DW$18, DW_AT_high_pc($C$DW$L$_test$2$E)
$C$DW$19	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$19, DW_AT_low_pc($C$DW$L$_test$5$B)
	.dwattr $C$DW$19, DW_AT_high_pc($C$DW$L$_test$5$E)
$C$DW$20	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$20, DW_AT_low_pc($C$DW$L$_test$6$B)
	.dwattr $C$DW$20, DW_AT_high_pc($C$DW$L$_test$6$E)
$C$DW$21	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$21, DW_AT_low_pc($C$DW$L$_test$7$B)
	.dwattr $C$DW$21, DW_AT_high_pc($C$DW$L$_test$7$E)
	.dwendtag $C$DW$17

	.dwattr $C$DW$3, DW_AT_TI_end_file("../TEST.C")
