...
;* Date/Time created: Sun Sep 01 14:26:53 2019                                 *
;*******************************************************************************
...
$C$DW$CU	.dwtag  DW_TAG_compile_unit
	.dwattr $C$DW$CU, DW_AT_name("../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C")
...
$C$IR_1:	.set	16
	...
	.field  	_h+0,24
	.field  	0,8
	.field	-17385,16			; _h[0] @ 0
	.field	12314,16			; _h[1] @ 16
	.field	-14200,16			; _h[2] @ 32
	.field	17123,16			; _h[3] @ 48
	.field	-3529,16			; _h[4] @ 64
	.field	-5786,16			; _h[5] @ 80
	.field	-19274,16			; _h[6] @ 96
	.field	-11688,16			; _h[7] @ 112
	.field	16393,16			; _h[8] @ 128
	.field	15478,16			; _h[9] @ 144
$C$IR_2:	.set	10
	...
	.field  	_rtest+0,24
	.field  	0,8
	.field	172,16			; _rtest[0] @ 0
	.field	173,16			; _rtest[1] @ 16
	.field	-432,16			; _rtest[2] @ 32
	.field	575,16			; _rtest[3] @ 48
	.field	-36,16			; _rtest[4] @ 64
	.field	142,16			; _rtest[5] @ 80
	.field	122,16			; _rtest[6] @ 96
	.field	-175,16			; _rtest[7] @ 112
	.field	80,16			; _rtest[8] @ 128
	.field	368,16			; _rtest[9] @ 144
	.field	-606,16			; _rtest[10] @ 160
	.field	436,16			; _rtest[11] @ 176
	.field	517,16			; _rtest[12] @ 192
	.field	-77,16			; _rtest[13] @ 208
	.field	48,16			; _rtest[14] @ 224
...
$C$DW$3	.dwtag  DW_TAG_subprogram, DW_AT_name("iircas51")
	.dwattr $C$DW$3, DW_AT_TI_symbol_name("_iircas51")
...
;	C:\ti\ccsv5\tools\compiler\c5500_4.4.1\bin\acp55.exe -@C:\\Users\\user\\AppData\\Local\\Temp\\1275612 
	.sect	".text"
	.global	_main
...
$C$DW$22	.dwtag  DW_TAG_subprogram, DW_AT_name("main")
	...
	.dwattr $C$DW$22, DW_AT_TI_begin_file("../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C")
	...
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C",line 71,column 1,is_stmt,address _main
...
$C$DW$23	.dwtag  DW_TAG_variable, DW_AT_name("i")
	...
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C",line 75,column 10,is_stmt
        MOV #0, *SP(#0) ; |75| 
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C",line 75,column 17,is_stmt
        MOV #16, AR2 ; |75| 
        MOV *SP(#0), AR1 ; |75| 
        CMP AR1 >= AR2, TC1 ; |75| 
        BCC $C$L2,TC1 ; |75| 
...
$C$L1:    
$C$DW$L$_main$2$B:
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C",line 75,column 30,is_stmt
        MOV AR1, T0 ; |75| 
        AMOV #_r, XAR3 ; |75| 
        MOV #0, *AR3(T0) ; |75| 
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C",line 75,column 25,is_stmt
        ADD #1, *SP(#0) ; |75| 
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C",line 75,column 17,is_stmt
        MOV *SP(#0), AR1 ; |75| 
        CMP AR1 < AR2, TC1 ; |75| 
...
$C$DW$L$_main$2$E:
$C$L2:    
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C",line 76,column 10,is_stmt
        MOV #0, *SP(#0) ; |76| 
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C",line 76,column 17,is_stmt
...
$C$L3:    
$C$DW$L$_main$4$B:
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C",line 76,column 36,is_stmt
        MOV AR1, T0 ; |76| 
        AMOV #_dbuffer, XAR3 ; |76| 
        MOV #0, *AR3(T0) ; |76| 
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C",line 76,column 31,is_stmt
        ADD #1, *SP(#0) ; |76| 
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C",line 76,column 17,is_stmt
        MOV *SP(#0), AR1 ; |76| 
        CMP AR1 < AR2, TC1 ; |76| 
...
$C$DW$L$_main$4$E:
$C$L4:    
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C",line 79,column 5,is_stmt
        MOV dbl(*(#_dp)), XAR3
        AMOV #_r, XAR2 ; |79| 
        AMOV #_h, XAR1 ; |79| 
        AMOV #_x, XAR0 ; |79| 
...
$C$DW$24	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$24, DW_AT_name("_iircas51")
	.dwattr $C$DW$24, DW_AT_TI_call

        CALL #_iircas51 ; |79| 
||      MOV #2, T0

                                        ; call occurs [#_iircas51] ; |79| 
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C",line 82,column 5,is_stmt
        MOV #20, T1 ; |82| 
        AMOV #_rtest, XAR1 ; |82| 
        AMOV #_r, XAR0 ; |82| 
        MOV #16, T0 ; |82| 
$C$DW$25	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$25, DW_AT_TI_call
        ...
        MOV T0, *(#_eflag) ; |82| 
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C",line 84,column 5,is_stmt
        CMP *(#_eflag) == #-1, TC1 ; |84| 
        BCC $C$L5,TC1 ; |84| 
                                        ; branchcc occurs ; |84| 
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C",line 86,column 9,is_stmt
...
$C$L5:    
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C",line 95,column 10,is_stmt
        MOV #0, *SP(#0) ; |95| 
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C",line 95,column 17,is_stmt
        MOV #16, AR2 ; |95| 
        MOV *SP(#0), AR1 ; |95| 
        CMP AR1 >= AR2, TC1 ; |95| 
        BCC $C$L7,TC1 ; |95| 
...
$C$L6:    
$C$DW$L$_main$8$B:
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C",line 95,column 30,is_stmt
        MOV AR1, T0 ; |95| 
        AMOV #_r, XAR3 ; |95| 
        MOV #0, *AR3(T0) ; |95| 
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C",line 95,column 25,is_stmt
        ADD #1, *SP(#0) ; |95| 
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C",line 95,column 17,is_stmt
        MOV *SP(#0), AR1 ; |95| 
        CMP AR1 < AR2, TC1 ; |95| 
...
$C$DW$L$_main$8$E:
$C$L7:    
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C",line 96,column 10,is_stmt
        MOV #0, *SP(#0) ; |96| 
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C",line 96,column 17,is_stmt
...
$C$L8:    
$C$DW$L$_main$10$B:
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C",line 96,column 36,is_stmt
        MOV AR1, T0 ; |96| 
        AMOV #_dbuffer, XAR3 ; |96| 
        MOV #0, *AR3(T0) ; |96| 
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C",line 96,column 31,is_stmt
        ADD #1, *SP(#0) ; |96| 
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C",line 96,column 17,is_stmt
        MOV *SP(#0), AR1 ; |96| 
        CMP AR1 < AR2, TC1 ; |96| 
...
$C$DW$L$_main$10$E:
$C$L9:    
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C",line 98,column 5,is_stmt
        MOV dbl(*(#_dp)), XAR3
        AMOV #_r, XAR2 ; |98| 
        AMOV #_h, XAR1 ; |98| 
        AMOV #_x, XAR0 ; |98| 
...
$C$DW$27	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$27, DW_AT_name("_iircas51")
	.dwattr $C$DW$27, DW_AT_TI_call

        CALL #_iircas51 ; |98| 
||      MOV #5, T1

                                        ; call occurs [#_iircas51] ; |98| 
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C",line 99,column 5,is_stmt
        MOV #2, T0
        AMOV #(_r+5), XAR2 ; |99| 
        AMOV #_h, XAR1 ; |99| 
        AMOV #(_x+5), XAR0 ; |99| 
...
$C$DW$28	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$28, DW_AT_name("_iircas51")
	.dwattr $C$DW$28, DW_AT_TI_call

        CALL #_iircas51 ; |99| 
||      MOV #5, T1

                                        ; call occurs [#_iircas51] ; |99| 
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C",line 100,column 5,is_stmt
        MOV #2, T0
        AMOV #(_r+10), XAR2 ; |100| 
        AMOV #_h, XAR1 ; |100| 
        AMOV #(_x+10), XAR0 ; |100| 
...
$C$DW$29	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$29, DW_AT_name("_iircas51")
	.dwattr $C$DW$29, DW_AT_TI_call

        CALL #_iircas51 ; |100| 
||      MOV #6, T1

                                        ; call occurs [#_iircas51] ; |100| 
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C",line 103,column 5,is_stmt
        MOV #20, T1 ; |103| 
        AMOV #_rtest, XAR1 ; |103| 
        AMOV #_r, XAR0 ; |103| 
        MOV #16, T0 ; |103| 
$C$DW$30	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$30, DW_AT_TI_call
        CALL #_test ; |103| 
                                        ; call occurs [#_test] ; |103| 
        MOV T0, *(#_eflag) ; |103| 
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C",line 105,column 5,is_stmt
        CMP *(#_eflag) == #-1, TC1 ; |105| 
        BCC $C$L10,TC1 ; |105| 
                                        ; branchcc occurs ; |105| 
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C",line 107,column 9,is_stmt
        MOV #-1, T0
$C$DW$31	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$31, DW_AT_TI_call
        CALL #_exit ; |107| 
                                        ; call occurs [#_exit] ; |107| 
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C",line 109,column 5,is_stmt
$C$L10:    
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C",line 110,column 1,is_stmt
        AADD #1, SP
	.dwcfi	cfa_offset, 1
...
$C$DW$33	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$33, DW_AT_name("C:\ti\workspace\MPUOS_Lab2\Debug\IIR51_T.asm:$C$L8:1:1567337213")
	.dwattr $C$DW$33, DW_AT_TI_begin_file("../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C")
	.dwattr $C$DW$33, DW_AT_TI_begin_line(0x60)
	.dwattr $C$DW$33, DW_AT_TI_end_line(0x60)
...
$C$DW$35	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$35, DW_AT_name("C:\ti\workspace\MPUOS_Lab2\Debug\IIR51_T.asm:$C$L6:1:1567337213")
	.dwattr $C$DW$35, DW_AT_TI_begin_file("../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C")
...
$C$DW$37	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$37, DW_AT_name("C:\ti\workspace\MPUOS_Lab2\Debug\IIR51_T.asm:$C$L3:1:1567337213")
	.dwattr $C$DW$37, DW_AT_TI_begin_file("../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C")
	.dwattr $C$DW$37, DW_AT_TI_begin_line(0x4c)
	.dwattr $C$DW$37, DW_AT_TI_end_line(0x4c)
...
$C$DW$39	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$39, DW_AT_name("C:\ti\workspace\MPUOS_Lab2\Debug\IIR51_T.asm:$C$L1:1:1567337213")
	.dwattr $C$DW$39, DW_AT_TI_begin_file("../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C")
	.dwattr $C$DW$39, DW_AT_TI_begin_line(0x4b)
	.dwattr $C$DW$39, DW_AT_TI_end_line(0x4b)
$C$DW$40	.dwtag  DW_TAG_TI_loop_range
	...
	.dwattr $C$DW$22, DW_AT_TI_end_file("../TMS320C55x-DSP Library-2013/EXAMPLES/iir51/IIR51_T.C")
...
$C$DW$43	.dwtag  DW_TAG_subrange_type
	.dwattr $C$DW$43, DW_AT_upper_bound(0x08)
	.dwendtag $C$DW$T$26
