...
;* Date/Time created: Sun Sep 01 14:27:27 2019                                 *
;*******************************************************************************
...
$C$DW$CU	.dwtag  DW_TAG_compile_unit
	.dwattr $C$DW$CU, DW_AT_name("../TMS320C55x-DSP Library-2013/EXAMPLES/CONVOL/CONVOL_T.C")
...
$C$DW$3	.dwtag  DW_TAG_subprogram, DW_AT_name("convol")
	.dwattr $C$DW$3, DW_AT_TI_symbol_name("_convol")
...
;	C:\ti\ccsv5\tools\compiler\c5500_4.4.1\bin\acp55.exe -@C:\\Users\\user\\AppData\\Local\\Temp\\1259612 
	.sect	".text"
	.global	_main
...
$C$DW$20	.dwtag  DW_TAG_subprogram, DW_AT_name("main")
	...
	.dwattr $C$DW$20, DW_AT_TI_begin_file("../TMS320C55x-DSP Library-2013/EXAMPLES/CONVOL/CONVOL_T.C")
	.dwattr $C$DW$20, DW_AT_TI_begin_line(0x41)
	.dwattr $C$DW$20, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$20, DW_AT_TI_max_frame_size(0x02)
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/CONVOL/CONVOL_T.C",line 66,column 1,is_stmt,address _main
...
$C$DW$21	.dwtag  DW_TAG_variable, DW_AT_name("i")
	...
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/CONVOL/CONVOL_T.C",line 70,column 10,is_stmt
        MOV #0, *SP(#0) ; |70| 
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/CONVOL/CONVOL_T.C",line 70,column 17,is_stmt
        MOV #256, AR2 ; |70| 
        MOV *SP(#0), AR1 ; |70| 
        CMP AR1 >= AR2, TC1 ; |70| 
        BCC $C$L2,TC1 ; |70| 
...
$C$L1:    
$C$DW$L$_main$2$B:
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/CONVOL/CONVOL_T.C",line 70,column 30,is_stmt
        MOV AR1, T0 ; |70| 
        AMOV #_r, XAR3 ; |70| 
        MOV #0, *AR3(T0) ; |70| 
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/CONVOL/CONVOL_T.C",line 70,column 25,is_stmt
        ADD #1, *SP(#0) ; |70| 
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/CONVOL/CONVOL_T.C",line 70,column 17,is_stmt
        MOV *SP(#0), AR1 ; |70| 
        CMP AR1 < AR2, TC1 ; |70| 
...
$C$DW$L$_main$2$E:
$C$L2:    
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/CONVOL/CONVOL_T.C",line 73,column 5,is_stmt
        AMOV #_r, XAR2 ; |73| 
        AMOV #_h, XAR1 ; |73| 
        AMOV #_x_np, XAR0 ; |73| 
        MOV #50, T1 ; |73| 
...
$C$DW$22	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$22, DW_AT_name("_convol")
	.dwattr $C$DW$22, DW_AT_TI_call
        CALL #_convol ; |73| 
                                        ; call occurs [#_convol] ; |73| 
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/CONVOL/CONVOL_T.C",line 76,column 5,is_stmt
        AMOV #_rtest, XAR1 ; |76| 
        AMOV #_r, XAR0 ; |76| 
        MOV #256, T0 ; |76| 
...
||      MOV #10, T1
        ...
        MOV T0, *(#_eflag) ; |76| 
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/CONVOL/CONVOL_T.C",line 78,column 5,is_stmt
        CMP *(#_eflag) == #-1, TC1 ; |78| 
        BCC $C$L3,TC1 ; |78| 
                                        ; branchcc occurs ; |78| 
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/CONVOL/CONVOL_T.C",line 80,column 9,is_stmt
        MOV #-1, T0
$C$DW$24	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/CONVOL/CONVOL_T.C",line 83,column 5,is_stmt
$C$L3:    
	.dwpsn	file "../TMS320C55x-DSP Library-2013/EXAMPLES/CONVOL/CONVOL_T.C",line 84,column 1,is_stmt
        AADD #1, SP
	.dwcfi	cfa_offset, 1
...
$C$DW$26	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$26, DW_AT_name("C:\ti\workspace\MPUOS_Lab2\Debug\CONVOL_T.asm:$C$L1:1:1567337247")
	.dwattr $C$DW$26, DW_AT_TI_begin_file("../TMS320C55x-DSP Library-2013/EXAMPLES/CONVOL/CONVOL_T.C")
	.dwattr $C$DW$26, DW_AT_TI_begin_line(0x46)
	.dwattr $C$DW$26, DW_AT_TI_end_line(0x46)
$C$DW$27	.dwtag  DW_TAG_TI_loop_range
	...
	.dwattr $C$DW$20, DW_AT_TI_end_file("../TMS320C55x-DSP Library-2013/EXAMPLES/CONVOL/CONVOL_T.C")
