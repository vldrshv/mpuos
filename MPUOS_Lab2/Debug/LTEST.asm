...
$C$DW$CU	.dwtag  DW_TAG_compile_unit
	.dwattr $C$DW$CU, DW_AT_name("../LTEST.C")
...
;	C:\ti\ccsv5\tools\compiler\c5500_4.4.1\bin\acp55.exe -@C:\\Users\\user\\AppData\\Local\\Temp\\1157212 
	.sect	".text"
	.global	_ltest

$C$DW$3	.dwtag  DW_TAG_subprogram, DW_AT_name("ltest")
	.dwattr $C$DW$3, DW_AT_low_pc(_ltest)
	.dwattr $C$DW$3, DW_AT_high_pc(0x00)
	.dwattr $C$DW$3, DW_AT_TI_symbol_name("_ltest")
	.dwattr $C$DW$3, DW_AT_external
	.dwattr $C$DW$3, DW_AT_type(*$C$DW$T$8)
	.dwattr $C$DW$3, DW_AT_TI_begin_file("../LTEST.C")
	.dwattr $C$DW$3, DW_AT_TI_begin_line(0x03)
	.dwattr $C$DW$3, DW_AT_TI_begin_column(0x07)
	.dwattr $C$DW$3, DW_AT_TI_max_frame_size(0x10)
	.dwpsn	file "../LTEST.C",line 5,column 1,is_stmt,address _ltest

	.dwfde $C$DW$CIE, _ltest
...
$C$DW$15	.dwtag  DW_TAG_variable, DW_AT_name("emax")
	...
	.dwattr $C$DW$15, DW_AT_location[DW_OP_bregx 0x24 12]
        ...
        MOV XAR1, dbl(*SP(#2))
        MOV XAR0, dbl(*SP(#0))
	.dwpsn	file "../LTEST.C",line 7,column 7,is_stmt
        MOV #-1, *SP(#9) ; |7| 
	.dwpsn	file "../LTEST.C",line 8,column 7,is_stmt
        MOV #0, AC0 ; |8| 
        MOV AC0, dbl(*SP(#10)) ; |8| 
	.dwpsn	file "../LTEST.C",line 9,column 7,is_stmt
        MOV AC0, dbl(*SP(#12)) ; |9| 
	.dwpsn	file "../LTEST.C",line 11,column 6,is_stmt
        MOV #0, *SP(#8) ; |11| 
	.dwpsn	file "../LTEST.C",line 11,column 10,is_stmt
        MOV *SP(#8), AR2 ; |11| 
        MOV *SP(#4), AR1 ; |11| 
        CMP AR2 >= AR1, TC1 ; |11| 
        BCC $C$L4,TC1 ; |11| 
...
$C$L1:    
$C$DW$L$_ltest$2$B:
	.dwpsn	file "../LTEST.C",line 13,column 5,is_stmt
        MOV dbl(*SP(#0)), XAR3
        MOV AR2, T0
        SFTL T0, #1 ; |13| 
...
||      MOV dbl(*AR3(T0)), AC0 ; |13| 
        ...
        SFTL T0, #1 ; |13| 
        MOV dbl(*SP(#2)), XAR3
        SUB AC0, dbl(*AR3(T0)), AC0 ; |13| 
        MOV AC0, AR1 ; |13| 
        ABS AR1, AR1 ; |13| 
        MOV AR1, AC0
        MOV AC0, dbl(*SP(#10)) ; |13| 
        MOV dbl(*SP(#6)), AC1 ; |13| 
        CMP AC0 <= AC1, TC1 ; |13| 
        BCC $C$L2,TC1 ; |13| 
                                        ; branchcc occurs ; |13| 
$C$DW$L$_ltest$2$E:
	.dwpsn	file "../LTEST.C",line 15,column 8,is_stmt
        MOV *SP(#8), AR1 ; |15| 
        MOV AR1, *SP(#9) ; |15| 
	.dwpsn	file "../LTEST.C",line 16,column 8,is_stmt
        MOV dbl(*SP(#10)), AC0 ; |16| 
        MOV AC0, dbl(*SP(#12)) ; |16| 
	.dwpsn	file "../LTEST.C",line 17,column 8,is_stmt
        B $C$L4   ; |17| 
                                        ; branch occurs ; |17| 
$C$L2:    
$C$DW$L$_ltest$5$B:
	.dwpsn	file "../LTEST.C",line 20,column 5,is_stmt
        MOV dbl(*SP(#12)), AC0 ; |20| 
        MOV dbl(*SP(#10)), AC1 ; |20| 
        CMP AC1 <= AC0, TC1 ; |20| 
        BCC $C$L3,TC1 ; |20| 
                                        ; branchcc occurs ; |20| 
$C$DW$L$_ltest$5$E:
$C$DW$L$_ltest$6$B:
	.dwpsn	file "../LTEST.C",line 20,column 22,is_stmt
        MOV dbl(*SP(#10)), AC0 ; |20| 
        MOV AC0, dbl(*SP(#12)) ; |20| 
$C$DW$L$_ltest$6$E:
$C$L3:    
$C$DW$L$_ltest$7$B:
	.dwpsn	file "../LTEST.C",line 11,column 14,is_stmt
        ADD #1, *SP(#8) ; |11| 
	.dwpsn	file "../LTEST.C",line 11,column 10,is_stmt
        MOV *SP(#4), AR1 ; |11| 
        MOV *SP(#8), AR2 ; |11| 
...
$C$DW$L$_ltest$7$E:
$C$L4:    
	.dwpsn	file "../LTEST.C",line 23,column 1,is_stmt
        MOV *SP(#9), T0 ; |23| 
	.dwpsn	file "../LTEST.C",line 24,column 1,is_stmt
        AADD #15, SP
	.dwcfi	cfa_offset, 1
...
$C$DW$17	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$17, DW_AT_name("C:\ti\workspace\MPUOS_Lab2\Debug\LTEST.asm:$C$L1:1:1567338119")
	.dwattr $C$DW$17, DW_AT_TI_begin_file("../LTEST.C")
	.dwattr $C$DW$17, DW_AT_TI_begin_line(0x0b)
	.dwattr $C$DW$17, DW_AT_TI_end_line(0x15)
$C$DW$18	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$18, DW_AT_low_pc($C$DW$L$_ltest$2$B)
	.dwattr $C$DW$18, DW_AT_high_pc($C$DW$L$_ltest$2$E)
$C$DW$19	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$19, DW_AT_low_pc($C$DW$L$_ltest$5$B)
	.dwattr $C$DW$19, DW_AT_high_pc($C$DW$L$_ltest$5$E)
$C$DW$20	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$20, DW_AT_low_pc($C$DW$L$_ltest$6$B)
	.dwattr $C$DW$20, DW_AT_high_pc($C$DW$L$_ltest$6$E)
$C$DW$21	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$21, DW_AT_low_pc($C$DW$L$_ltest$7$B)
	.dwattr $C$DW$21, DW_AT_high_pc($C$DW$L$_ltest$7$E)
	.dwendtag $C$DW$17

	.dwattr $C$DW$3, DW_AT_TI_end_file("../LTEST.C")
...
$C$DW$T$19	.dwtag  DW_TAG_typedef, DW_AT_name("LDATA")
